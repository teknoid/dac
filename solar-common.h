...
#define FLAG_AKKU_DCHARGE		(1 << 1)
#define FLAG_GRID_DLOAD			(1 << 2)
...
#define GSTATE_HEADER	"    pv pvmin pvavg pvmax ↑grid ↓grid today  tomo   sod   eod   soc   ttl  succ  foca avail  need  surv  clim  dlim  msoc flags"
struct _gstate {
	int pv;
	int pvmin;
	int pvavg;
