...
static void dump() {
	...
	xdebug("\nWIFI %d Stations, %d Zombies, %d Home, %d Cached, %d Controls, %lu Lines", scount, zombies->ccount, home->ccount, cache->ccount, control->ccount, line_count);
	dump_compact();
	dump_flat();
