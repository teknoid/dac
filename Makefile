...
#COBJS-TRON 		= $(COBJS-COMMON) mpd.o replaygain.o mp3gain-id3.o mp3gain-ape.o dac-alsa.o button.o lcd.o mqtt.o tasmota.o xmas.o shutter.o flamingo.o fronius-api.o curl.o mosmix.o aqua.o gpio-dummy.o
