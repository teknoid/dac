...
solar: clean mcp.o utils.o solar-modbus.o solar-collector.o solar-dispatcher.o mosmix.o sunspec.o sensors.o i2c.o tasmota.o mqtt.o frozen.o
	$(CC) $(CFLAGS) -L$(LIB) -o solar mcp.o utils.o solar-modbus.o solar-collector.o solar-dispatcher.o mosmix.o sunspec.o sensors.o i2c.o tasmota.o mqtt.o frozen.o -lmodbus -lmqttc -lm
